...
const cacheName = 'Asignment3-2021-03-14 21:36:15.474937'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Asignment3'.length) === 'Asignment3') {
